...
while in_use == True:
	...
	if(eval(reply)==1):
		(cash_in_hand,checking_account,saving_account)=current_user.fetch_incomes_data()
		views.display_current_income_info(cash_in_hand,checking_account,saving_account)
		...
		(cash_in_hand,name_of_bank,checking_account,saving_account)=views.update_user_info_income()
		current_user.update_incomes(cash_in_hand,checking_account,saving_account)
